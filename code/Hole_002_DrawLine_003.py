...
def main(direction, input_file, prod_name):
    FileLoc = '../../result/01_DrawLine/'+prod_name
    ...
    # direction = 'N'
    # input_file = '../image_demo/2024-08-22_'+direction+'1.BMP'
    ...
    cv2.imwrite('../../result/01_DrawLine/'+prod_name+'/drawn_image_'+direction+'.jpg', param['img'])
    cv2.imwrite('../../result/01_DrawLine/'+prod_name+'/black_image_with_lines_'+direction+'.jpg', param['black_img'])
