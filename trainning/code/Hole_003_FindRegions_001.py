...
def main(direction, input_file, prod_name):
    # direction = 'N'
    # input_file_1 = '../image_demo/2024-08-22_'+direction+'1.BMP'
    input_file_1 = input_file
    input_file_2 = 'result/01_DrawLine/'+prod_name+'/drawn_image_'+direction+'.jpg'
    input_file_3 = 'result/01_DrawLine/'+prod_name+'/black_image_with_lines_'+direction+'.jpg'
    
    FileLoc = 'result/02_Region/'+prod_name
    try:
        os.mkdir(FileLoc)
    except OSError:
    ...
    for i, region in enumerate(regions):
        ...
        # Save the mask image
        cv2.imwrite(f'result/02_Region/'+prod_name+'/region_'+direction+'_'+str(i)+'_mask.png', mask)
